...
hist(Concentration.AVG$PPM.Pb.in.sample[Concentration.AVG$Sample.type == "soil"], main="Histogram of dirt Pb concentrations", xlab="Pb concentration")

#Histogram of V dirt concentrations
hist(Concentration.AVG$PPM.V.in.sample[Concentration.AVG$Sample.type == "soil"], main="Histogram of dirt V concentrations", xlab="V concentration")

#Histogram of Cr dirt concentrations
hist(Concentration.AVG$PPM.Cr.in.sample[Concentration.AVG$Sample.type == "soil"], main="Histogram of dirt Cr concentrations", xlab="Cr concentration")

#Histogram of Mn dirt concentrations
hist(Concentration.AVG$PPM.Mn.in.sample[Concentration.AVG$Sample.type == "soil"], main="Histogram of dirt Pb concentrations", xlab="Mn concentration")
...
hist(Concentration.AVG$PPM.Cu.in.sample[Concentration.AVG$Sample.type == "soil"], main="Histogram of dirt Cu concentrations", xlab="Cu concentration")

#Histogram of Zn dirt concentrations
hist(Concentration.AVG$PPM.Zn.in.sample[Concentration.AVG$Sample.type == "soil"], main="Histogram of dirt Zn concentrations", xlab="Zn concentration")


#CATERPILLAR CONCENTRATIONS
...
#df <- data.frame(
#  x=Concentration.AVG$Site.ID,
#  y=Concentration.AVG$PPM.Cd.in.sample
#)
#
...
df <- data.frame(
  x=Concentration.AVG %>% group_by(Site.ID),
  y=Concentration.AVG$PPM.Pb.in.sample
)

ggplot(data=Concentration.AVG, aes(x=Site.ID,y=PPM.Pb.in.sample)) +
  geom_col(
    mapping = NULL,
    data = NULL,
