...
```{r}
#PPM of Cd in Buffalo River Sediment for both dilutions
...
Raw.data$PPM.Cd.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA

#PPM of Pb in Buffalo River Sediment for both dilutions
Raw.data<-Raw.data%>%mutate(PPM.Pb.in.buffalo=Raw.data$Pb208.LR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)/1000)

Raw.data$PPM.Pb.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA

#PPM of V in Buffalo River Sediment for both dilutions
...
Raw.data$PPM.V.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA

#PPM of Cr in Buffalo River Sediment for both dilutions
...
Raw.data$PPM.Cr.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA

#PPM of Mn in Buffalo River Sediment for both dilutions
Raw.data<-Raw.data%>%mutate(PPM.Mn.in.buffalo=Raw.data$Mn55.MR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)/1000)

Raw.data$PPM.Mn.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA

#PPM of Ni in Buffalo River Sediment for both dilutions
...
Raw.data$PPM.Ni.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA
...
Raw.data$PPM.Cu.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA

#PPM of Zn in Buffalo River Sediment for both dilutions
Raw.data<-Raw.data%>%mutate(PPM.Zn.in.buffalo=Raw.data$Zn66.MR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)/1000)

Raw.data$PPM.Zn.in.buffalo[Raw.data$Sample.type=="soil.diluted" | Raw.data$Sample.type== "soil" | Raw.data$Sample.type== "cata"| Raw.data$Sample.type== "leaf.control" | Raw.data$Sample.type== "leaf"]<-NA
```
...
#Cd transfer factor = conc of leaf / conc of soil
transfer.factor.Cd = sum.AVG$meanCd[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanCd[sum.AVG$Sample.type =="soil"]
#Cd trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Cd = sum.AVG$meanCd[sum.AVG$Sample.type =="cata"] / sum.AVG$meanCd[sum.AVG$Sample.type =="leaf"]
#Cd bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Cd = sum.AVG$meanCd[sum.AVG$Sample.type =="cata"] / sum.AVG$meanCd[sum.AVG$Sample.type =="soil"]

#Pb transfer factor = conc of leaf / conc of soil
transfer.factor.Pb = sum.AVG$meanPb[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanPb[sum.AVG$Sample.type =="soil.diluted"]
#Pb trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Pb = sum.AVG$meanPb[sum.AVG$Sample.type =="cata"] / sum.AVG$meanPb[sum.AVG$Sample.type =="leaf"]
#Pb bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Pb = sum.AVG$meanPb[sum.AVG$Sample.type =="cata"] / sum.AVG$meanPb[sum.AVG$Sample.type =="soil.diluted"]

#V transfer factor = conc of leaf / conc of soil
transfer.factor.V = sum.AVG$meanV[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanV[sum.AVG$Sample.type =="soil.diluted"]
#V trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.V = sum.AVG$meanV[sum.AVG$Sample.type =="cata"] / sum.AVG$meanV[sum.AVG$Sample.type =="leaf"]
#V bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.V = sum.AVG$meanV[sum.AVG$Sample.type =="cata"] / sum.AVG$meanV[sum.AVG$Sample.type =="soil.diluted"]

#Cr transfer factor = conc of leaf / conc of soil
transfer.factor.Cr = sum.AVG$meanCr[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanCr[sum.AVG$Sample.type =="soil"]
#Cr trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Cr = sum.AVG$meanCr[sum.AVG$Sample.type =="cata"] / sum.AVG$meanCr[sum.AVG$Sample.type =="leaf"]
#Cr bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Cr = sum.AVG$meanCr[sum.AVG$Sample.type =="cata"] / sum.AVG$meanCr[sum.AVG$Sample.type =="soil"]

#Mn transfer factor = conc of leaf / conc of soil
transfer.factor.Mn = sum.AVG$meanMn[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanMn[sum.AVG$Sample.type =="soil.diluted"]
#Mn trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Mn = sum.AVG$meanMn[sum.AVG$Sample.type =="cata"] / sum.AVG$meanMn[sum.AVG$Sample.type =="leaf"]
#Mn bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Mn = sum.AVG$meanMn[sum.AVG$Sample.type =="cata"] / sum.AVG$meanMn[sum.AVG$Sample.type =="soil.diluted"]

#Ni transfer factor = conc of leaf / conc of soil
transfer.factor.Ni = sum.AVG$meanNi[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanNi[sum.AVG$Sample.type =="soil"]
#Ni trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Ni = sum.AVG$meanNi[sum.AVG$Sample.type =="cata"] / sum.AVG$meanNi[sum.AVG$Sample.type =="leaf"]
#Ni bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Ni = sum.AVG$meanNi[sum.AVG$Sample.type =="cata"] / sum.AVG$meanNi[sum.AVG$Sample.type =="soil"]

#Cu transfer factor = conc of leaf / conc of soil
transfer.factor.Cu = sum.AVG$meanCu[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanCu[sum.AVG$Sample.type =="soil.diluted"]
#Cu trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Cu = sum.AVG$meanCu[sum.AVG$Sample.type =="cata"] / sum.AVG$meanCu[sum.AVG$Sample.type =="leaf"]
#Cu bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Cu = sum.AVG$meanCu[sum.AVG$Sample.type =="cata"] / sum.AVG$meanCu[sum.AVG$Sample.type =="soil.diluted"]

#Zn transfer factor = conc of leaf / conc of soil
transfer.factor.Zn = sum.AVG$meanZn[sum.AVG$Sample.type =="leaf"] / sum.AVG$meanZn[sum.AVG$Sample.type =="soil.diluted"]
#Zn trophic transfer factor = conc of cata / conc of leaf
trophic.transfer.factor.Zn = sum.AVG$meanZn[sum.AVG$Sample.type =="cata"] / sum.AVG$meanZn[sum.AVG$Sample.type =="leaf"]
#Zn bioaccumulation factor = conc of cata / conc of soil
bioaccumulation.factor.Zn = sum.AVG$meanZn[sum.AVG$Sample.type =="cata"] / sum.AVG$meanZn[sum.AVG$Sample.type =="soil.diluted"]

#sum.AVG<-sum.AVG%>%add_row(transfer.factor.Cd)
