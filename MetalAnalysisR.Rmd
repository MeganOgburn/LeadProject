...
##Oginial way I was doing things:
...
Raw.data$PPM.V.in.sample[Raw.data$Sample.type == "soil.diluted" | Raw.data$Sample.type ==  "soil.control.diluted"]<-PPM.Pb.in.diluted.dirt[Raw.data$Sample.type == "soil.diluted" | Raw.data$Sample.type ==  "soil.control.diluted"]
...
Raw.data<-Raw.data%>%mutate(PPM.Cr.in.diluted.dirt=Raw.data$Cr52.MR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)*(Raw.data$Second.Orange.Volume.in.mL/Raw.data$Extraction.from.Orange.in.mL))
Raw.data<-Raw.data%>%mutate(PPM.Cr.in.diluted.dirt=PPM.Cr.in.diluted.dirt/1000)
...
Raw.data<-Raw.data%>%mutate(PPM.Mn.in.diluted.dirt=Raw.data$Mn55.MR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)*(Raw.data$Second.Orange.Volume.in.mL/Raw.data$Extraction.from.Orange.in.mL))
Raw.data<-Raw.data%>%mutate(PPM.Mn.in.diluted.dirt=PPM.Mn.in.diluted.dirt/1000)
...
Raw.data<-Raw.data%>%mutate(PPM.Cu.in.diluted.dirt=Raw.data$Cu63.MR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)*(Raw.data$Second.Orange.Volume.in.mL/Raw.data$Extraction.from.Orange.in.mL))
Raw.data<-Raw.data%>%mutate(PPM.Cu.in.diluted.dirt=PPM.Cu.in.diluted.dirt/1000)
...
Raw.data<-Raw.data%>%mutate(PPM.Zn.in.diluted.dirt=Raw.data$Zn66.MR.*(Raw.data$Final.Blue.Volume.in.mL/Raw.data$Mass..in.g.of.digested.sample.)*(Raw.data$First.Orange.Volume.in.mL/Raw.data$Extraction.from.blue.in.mL)*(Raw.data$Second.Orange.Volume.in.mL/Raw.data$Extraction.from.Orange.in.mL))
Raw.data<-Raw.data%>%mutate(PPM.Zn.in.diluted.dirt=PPM.Zn.in.diluted.dirt/1000)
...
```{r}
Concentration.AVG <- Raw.data %>% filter(Isotope=="Concentration AVG") %>% select(Sample.ID,Sample.type,PPM.Cd.in.sample,PPM.Pb.in.sample)
