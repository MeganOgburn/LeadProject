...
```{r}
Concentration.AVG <- Raw.data %>% filter(Isotope=="Concentration AVG") %>% select(Sample.ID, Sample.type, PPM.Cd.in.sample, PPM.Pb.in.sample, PPM.V.in.sample, PPM.Cr.in.sample, PPM.Mn.in.sample, PPM.Ni.in.sample, PPM.Cu.in.sample, PPM.Zn.in.sample, Site.ID)
...
```{r}
Concentration.STD <- Raw.data %>% filter(Isotope=="Concentration STD") %>% select(Sample.ID, Sample.type, PPM.Cd.in.sample, PPM.Pb.in.sample, PPM.V.in.sample, PPM.Cr.in.sample, PPM.Mn.in.sample, PPM.Ni.in.sample, PPM.Cu.in.sample, PPM.Zn.in.sample, Site.ID)
...
tidyConc <- Concentration.AVG %>% gather("metal", "concentration", -Sample.ID, -Site.ID, -Sample.type)
...
#test for correlation in Cu between leaves and caterpillars
